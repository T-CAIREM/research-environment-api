...
#     created_billing_account_schema = schemas.CreatedBillingAccount()
#     serialized_billing_account = created_billing_account_schema.dump(linked_billing_account)
...
@app.route("/list/<cloud_identity_id>", methods=["GET"])
