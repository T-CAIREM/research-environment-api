...
def create_workbench():
    ...
    workspace = services.get_active_google_project(project_id=workbench_creation_request["workspace_project_id"], username=username)
    workspace_region = entities.Region(workspace.labels["region"])

    workbench_entity = entities.WorkbenchCreate(**workbench_creation_request, region=workspace_region)
