...
def stop_jupyter_workbench(
    ...
    workbench = services.get_jupyter_workbench(
...
def stop_rstudio_workbench(
    ...
    workbench = services.get_rstudio_workbench(
        workbench_stop_request.workspace_project_id,
        workbench_stop_request.workbench_resource_id,
...
def start_rstudio_workbench(
    ...
    workbench = services.get_rstudio_workbench(
        ...
        workbench_start_request.workbench_resource_id,
