...
CREATE_COLLABORATIVE_WORKBENCH_STEPS_PARTIAL = [
    {
        "id": "collaborative_workbench_creation_setup",
        "name": "gcr.io/cloud-builders/git",
        "entrypoint": "/bin/sh",
        "args": ["-c", "ls && pwd"],
        "dir_": "terraform-workbench-creation",
    ...
    {
        "id": "collaborative_workbench_creation_set_backend_bucket",
        "name": "python",
        "args": [
            "python3",
    ...
    {
        "id": "collaborative_workbench_creation_set_config",
        "name": "python",
        "args": [
            "python3",
            "workbench/jupyter/python4.py",
    ...
    {
        "id": "collaborative_workbench_creation_terraform_init",
        "name": "hashicorp/terraform",
    ...
    {
        "id": "collaborative_workbench_creation_terraform_apply_script",
        "name": "hashicorp/terraform",
        "entrypoint": "/bin/sh",
        "args": ["workbench/jupyter-collaborative/terraform_apply.sh"],
        "dir_": "terraform-workbench-creation",
    },
]
...
DESTROY_SHARED_WORKSPACE_STEPS_PARTIAL = [
    ...
    {
        # Without this rewrite the vpc destroy below initialized against the
        # pristine foo/terraform.tfstate prefix instead of this workspace's
        # vpc state, so the perimeter membership was never actually destroyed.
        "id": "shared_workspace_destruction_vpc_setup",
        "name": "python",
        "args": [
            "python3",
            "vpc-sp/python3.py",
...
CREATE_COLLABORATIVE_WORKBENCH_STEPS = [
    *CLONE_GITHUB_REPO,
    *CREATE_COLLABORATIVE_WORKBENCH_STEPS_PARTIAL,
]
